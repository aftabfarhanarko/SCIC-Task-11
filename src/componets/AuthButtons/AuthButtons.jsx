...
const AuthButtons = () => {
  ...
  return (
    <>
      <div className="flex  hidden  md:block gap-2 items-center">
        {session.status === "authenticated" ? (
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="text-amber-400 px-5 py-2.5 text-[11px] uppercase tracking-[0.15em] font-medium transition-all duration-300 flex items-center gap-2 border border-amber-400 hover:border-amber-400/50 rounded-lg group"
            >
              <LogIn
                size={16}
      ...
      <div className="flex md:hidden items-center gap-3">
        {session.status === "authenticated" ? (
          <>
            ...
            <button
              onClick={() => signOut()}
              className="flex items-center gap-2 px-4 py-2 text-xs uppercase tracking-wider text-ambar-400 border border-amber-400 rounded-md hover:bg-amber-400/10 transition"
            >
          ...
          <>
            ...
            <button
              onClick={() => router.push("/login")}
              className="flex items-center gap-2 px-4 py-2 text-xs uppercase tracking-wider text-amber-400 border border-amber-400 rounded-md"
            >
              <LogIn size={14} />
              Login
            </button>
            ...
            <button
              onClick={() => router.push("/register")}
              className="flex items-center gap-2 px-4 py-2 text-xs uppercase tracking-wider bg-amber-500 text-white rounded-md"
            >
              <UserPlus size={14} />
              Register
            </button>
